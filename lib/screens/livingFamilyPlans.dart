...
class LivingFamilyPlans extends StatefulWidget {
  static const String routename = '/livingFamilyPlans-info';
  @override
  _LivingFamilyPlansState createState() => _LivingFamilyPlansState();
}

class _LivingFamilyPlansState extends State<LivingFamilyPlans> {
  int select = -1;
  int select1 = -1;
  int select2 = -1;
  List live1 = [
